...
GNUTERM = "wxt"
set yrange [0:1100]
plot "output.dat" using ($1/1000000):17 title "max remaining" with lines, "output.dat" using ($1/1000000):16 title "remaining" with lines, "output.dat" using ($1/1000000):18 title "min remaining" with lines
#    EOF
