...
set yrange [0:1100]
set xrange [0:5000]
plot "output.dat" using ($1/1000000):17 title "max remaining" with lines, "output.dat" using ($1/1000000):19 title "mean remaining" with lines, "output.dat" using ($1/1000000):18 title "min remaining" with lines
#    EOF
