...
GNUTERM = "wxt"
plot "output.dat" using 9:($21+$22+$23) title "overflowed" with lines, "output.dat" using 9:($21+$22) title "created" with lines, "output.dat" using 9:22 title "dud" with lines
#    EOF
